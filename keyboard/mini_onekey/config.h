...
#define PRODUCT "ChibiOS TMK Phantom"
#define USBSTR_PRODUCT         'C', '\x00', 'h', '\x00', 'i', '\x00', 'b', '\x00', 'i', '\x00', 'O', '\x00', 'S', '\x00', ' ', '\x00', 'T', '\x00', 'M', '\x00', 'K', '\x00', ' ', '\x00', 'P', '\x00', 'h', '\x00', 'a', '\x00', 'n', '\x00', 't', '\x00', 'o', '\x00', 'm', '\x00'
