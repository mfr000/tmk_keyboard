...
#define MAPLE_BUTTON_PORT GPIOB
#define MAPLE_BUTTON_PIN GPIOB_BOOT0_BUTTON
#define MAPLE_LED_PORT GPIOB
#define MAPLE_LED_PIN GPIOB_LED

#define LED_ON()    do { palSetPad(MAPLE_LED_PORT, MAPLE_LED_PIN) ;} while (0)
#define LED_OFF()   do { palClearPad(MAPLE_LED_PORT, MAPLE_LED_PIN); } while (0)
...
static void  init_cols(void)
{
    ...
    palSetPadMode(MAPLE_BUTTON_PORT, MAPLE_BUTTON_PIN, PAL_MODE_INPUT);
}
